...
class Banners_turismo{
    ...
    public function updateBanner(){
        try {
            ...
            $stmt = $this->con->prepare('UPDATE banners_turismo SET path = ? WHERE id = ?');
    ...
    public function getAll(){
        try {
            ...
            $sql = 'SELECT * FROM banners_turismo';
    ...
    public function getBanner(){
        try {
            ...
            $stmt = $this->con->prepare('SELECT * FROM banners_turismo WHERE id = :id');
